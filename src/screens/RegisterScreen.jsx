...
const RegisterScreen = ({navigation}) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <TextInput style={styles.input} placeholder={"Name"} onChangeText={text => setName(name)}/>
            <TextInput style={styles.input} placeholder={"Email"} onChangeText={text => setEmail(email)}/>
